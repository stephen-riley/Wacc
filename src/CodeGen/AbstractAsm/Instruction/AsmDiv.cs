...
public record AsmDiv(AsmOperand Src1, AsmOperand Src2, AsmDestOperand Dst) : AsmInstruction
{
    public override int OperandCount => 3;

    public override string EmitArmString() => $"        sdiv    {Dst.EmitArmString()}, {Src1.EmitArmString()}, {Src2.EmitArmString()}";

    public override string EmitIrString() => $"Div({Src1.EmitIrString()}, {Src2.EmitIrString()}, {Dst.EmitIrString()})";
