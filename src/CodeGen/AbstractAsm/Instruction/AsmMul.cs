...
public record AsmMul(AsmOperand Src1, AsmOperand Src2, AsmDestOperand Dst) : AsmInstruction
{
    public override int OperandCount => 3;

    public override string EmitArmString() => $"        mul     {Dst.EmitArmString()}, {Src1.EmitArmString()}, {Src2.EmitArmString()}";

    public override string EmitIrString() => $"Mul({Src1.EmitIrString()}, {Src2.EmitIrString()}, {Dst.EmitIrString()})";
